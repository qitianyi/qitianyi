...
//	private int numberofRows;
	...
	static {
		...
		docs.put("0001",new Doc("0001","jack",timestamp,"Age Source Java","Age.java","txt"));
...
//			connectToDB = false;
	...
	public static boolean insertDoc(String ID, String creator, Timestamp timestamp, String description, String filename,String type1) throws SQLException,IllegalStateException{
		Doc doc;		
	
		if (docs.containsKey(ID))
			return false;
		else{
			doc = new Doc(ID,creator,timestamp,description,filename,type1);
			docs.put(ID, doc);
			return true;
		}
	} 
